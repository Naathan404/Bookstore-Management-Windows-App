...
using Bookstore.WPF.ViewModels; // Khai báo namespace chứa CustomerViewModel
...
//    public partial class CustomerView : UserControl
//    {
//        private ObservableCollection<CustomerResponse> DanhSachKhachHang = new();
//        private ObservableCollection<CustomerResponse> DanhSachKhachHangGoc = new();
//        private CustomerResponse? KhachHangDangChon;
...
//        {
//            DanhSachKhachHangGoc = new ObservableCollection<CustomerResponse>
//            {
...
//            DanhSachKhachHang = new ObservableCollection<CustomerResponse>(filtered);
...
//        {
//            if (sender is Button btn && btn.Tag is CustomerResponse kh)
//            {
//                DangSua = true;
...
//            else
//            {
//                DanhSachKhachHangGoc.Add(new CustomerResponse
//                {
